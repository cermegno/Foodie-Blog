...
def dumpmeals():
    ...
    for eachmeal in sorted(r.keys('meal*')):
        ...
        response += "Description : " + str(r.hget(eachmeal,'description'),'utf-8') + "<br><br>"
        response += """<img src="http://131030155286710005.public.ecstestdrive.com/foodblog/{}" width=500><br>""".format(str(eachmeal,'utf-8'))
        response += "<hr>"
